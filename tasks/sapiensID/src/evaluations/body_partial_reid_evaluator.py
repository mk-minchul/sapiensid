...
try:
    ...
    from .body_partial_reid.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_partial_reid.evaluate import evaluate
...
class BodyPartialReidEvaluator(BaseEvaluator):
...
if __name__ == '__main__':
    evaluator = BodyPartialReidEvaluator(name='body_occluded_reid_evaluator', data_path='/ssd2/data/body/validation_sets/occluded_reid_test', transform=None, fabric=None, batch_size=128, num_workers=0)
