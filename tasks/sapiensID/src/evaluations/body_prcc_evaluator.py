...
try:
    ...
    from .body_prcc.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_prcc.evaluate import evaluate
...
class BodyPRCCEvaluator(BaseEvaluator):
    ...
    def compute_metric(self, collection, collection_flip):
        ...
        result = evaluate(
            ...
            meta=self.meta,
            save_artifacts_path=self.save_artifacts_path,
        )
        return result


if __name__ == '__main__':
    evaluator = BodyPRCCEvaluator(name='body_prcc_evaluator', data_path='/ssd2/data/body/validation_sets/prcc_test', transform=None, fabric=None, batch_size=128, num_workers=0)
