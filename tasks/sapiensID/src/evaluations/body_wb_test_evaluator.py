...
try:
    ...
    from .body_wb_test.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_wb_test.evaluate import evaluate
...
class BodyWebBodyTestEvaluator(BaseEvaluator):
...
if __name__ == '__main__':
    evaluator = BodyWebBodyTestEvaluator(name='body_wb_test_evaluator', data_path='/ssd2/data/body/validation_sets/webbody_test_25/webbody_test_25', transform=None, fabric=None, batch_size=128, num_workers=0)
