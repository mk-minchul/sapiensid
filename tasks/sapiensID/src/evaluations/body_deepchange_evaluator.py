...
try:
    ...
    from .body_deep_change.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_deep_change.evaluate import evaluate
...
class BodyDeepChangeEvaluator(BaseEvaluator):
...
if __name__ == '__main__':
    evaluator = BodyDeepChangeEvaluator(name='body_deep_change_evaluator', data_path='/ssd2/data/body/validation_sets/prcc_test', transform=None, fabric=None, batch_size=128, num_workers=0)
