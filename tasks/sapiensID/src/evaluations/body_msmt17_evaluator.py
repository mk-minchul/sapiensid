...
try:
    ...
    from .body_msmt17.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_msmt17.evaluate import evaluate
...
class BodyMSMT17Evaluator(BaseEvaluator):
...
if __name__ == '__main__':
    evaluator = BodyMSMT17Evaluator(name='body_msmt17_evaluator', data_path='/ssd2/data/body/validation_sets/msmt17_test', transform=None, fabric=None, batch_size=128, num_workers=0)
