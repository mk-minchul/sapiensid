...
try:
    ...
    from .body_ccda.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_ccda.evaluate import evaluate
...
class BodyCCDAEvaluator(BaseEvaluator):
...
if __name__ == '__main__':
    evaluator = BodyCCDAEvaluator(name='body_ccda_evaluator', data_path='/ssd2/data/body/validation_sets/market_1501_test', transform=None, fabric=None, batch_size=128, num_workers=0)
