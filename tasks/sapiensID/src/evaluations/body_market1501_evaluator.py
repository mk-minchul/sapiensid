...
try:
    ...
    from .body_market1501.evaluate import evaluate
except:
    from base_evaluator import BaseEvaluator
    from body_market1501.evaluate import evaluate
...
class BodyMarket1501Evaluator(BaseEvaluator):
...
if __name__ == '__main__':
    evaluator = BodyMarket1501Evaluator(name='body_market1501_evaluator', data_path='/ssd2/data/body/validation_sets/market_1501_test', transform=None, fabric=None, batch_size=128, num_workers=0)
