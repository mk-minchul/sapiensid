...
class CCVID(object):
    ...
    """
    def __init__(self, root='/ssd2/data/body/personReID', sampling_step=64, seq_len=16, stride=4, **kwargs):
        ...
        self.num_test_pids = num_gallery_pids
    ...
    def _process_data(self, data_path, relabel=False, clothes2label=None):
        ...
        for tracklet_path, pid, clothes_label in tracklet_path_list:
            ...
            for image_path in img_paths:
                tracklets.append((image_path, pid, camid, clothes_id))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='ccvid_test')
