...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='/ssd2/data/body/personReID/Occluded_REID')
    parser.add_argument('--dataset_name', type=str, default='occluded_reid_test')
