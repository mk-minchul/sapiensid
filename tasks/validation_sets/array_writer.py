...
class ArrayPathWriter:
    def __init__(self, save_root, filename, idx_header, array_header, n_digits=5):
        ...
        assert idx_header[0] == 'local_idx'
        assert idx_header[1] == 'path'
    ...
    def write_array(self, idx, path, array):
        """
        ...
        fstring = f'{idx},{path},{formatted_values}\n'
