...
if __name__ == '__main__':
    ...
    # set seed
    np.random.seed(42)
    # tsv_path = '/hdd4/data/faces/webface260m/WebFaceV2_subset_by_face_score_v1/whole_body_bundle/raw_img_parquets_640_yolo_cropped/cluster_eps:0.7_min_samples:2_max_group_per_label:1/facefilter_0.95_merge_threshold_0.7_ambiguous_threshold_0.6_val_sim_threshold_0.7_image_size_384/train.tsv'
    root = '/mckim/temp'
